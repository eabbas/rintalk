@extends('welcome')
    ...
    @section('content')
     <h1 class="text-2xl font-bold text-gray-800 text-center mb-5">فرم ویرایش پیوست</h1>
        <form action="{{ route('LessonAttachment.update') }}" method="post" enctype='multipart/form-data'>
            @csrf
            <input type="hidden" name="id" value="{{ $LessonAttachment->id }}">
                        ...
                        <div class="w-full grid grid-cols-1 lg:grid-cols-2 gap-3 my-4">
                             <div class="w-full flex flex-col gap-3 max-md:flex-col max-md:gap-1">
                                ...
                                <div
                                    ...
                                    <input class="p-4 w-full focus:outline-none text-sm font-bold mr-2" type="text"
                                        name='title' placeholder="نام  پیوست خود را وارد کنید" value="{{$LessonAttachment->title}}" required>
                                </div>
                            </div>
                            <div class="w-full flex flex-col gap-3 max-md:flex-col max-md:gap-1">
                            ...
                            <div class="w-full flex flex-col gap-3 max-md:flex-col max-md:gap-1">
                                ...
                                <div
                                    class="rounded-lg focus:border-none focus:outline-none focus:bg-[#F1F1F4] bg-[#F9F9F9] text-[#99A1B7] w-full flex">
                                    <input class="p-4 w-full focus:outline-none text-sm font-bold mr-2" type="text"
                                        name='summary' placeholder="خلاصه پیوست راوارد کنید" value="{{$LessonAttachment->summary}}">
                                </div>
                            </div>
                            <div class="w-full flex flex-col gap-3 max-md:flex-col max-md:gap-1">
                                ...
                                <div
                                    class="rounded-lg focus:border-none focus:outline-none focus:bg-[#F1F1F4] bg-[#F9F9F9] text-[#99A1B7] w-full flex">
                                    <input class="p-4 w-full focus:outline-none text-sm font-bold mr-2" type="text"
                                        name='price' placeholder="قیمت پیوست(تومان) راوارد کنید" value="{{$LessonAttachment->price}}">
                                </div>
                            </div>
                            <div class="w-full flex flex-col gap-3 max-md:flex-col max-md:gap-1">
                                ...
                                <div
                                    class="rounded-lg focus:border-none focus:outline-none focus:bg-[#F1F1F4] bg-[#F9F9F9] text-[#99A1B7] w-full flex">
                                    <input class="p-4 w-full focus:outline-none text-sm font-bold mr-2" type="text"
                                        name='discount' placeholder="تخفیف پیوست(تومان) راوارد کنید" value="{{$LessonAttachment->discount}}">
                                </div>
                            </div>
                            </div> 
                            <div class="w-full flex flex-col gap-3 max-md:flex-col max-md:gap-1 lg:col-span-2">
                                ...
                                <div
                                    ...
                                    <textarea class="p-4 w-full focus:outline-none text-sm font-bold mr-2" type="text"
                                        ...
                                        class="w-full px-3 py-1 md:px-2 outline-none text-gray-500">{{$LessonAttachment->description}}</textarea>
                                </div>
                            </div>
