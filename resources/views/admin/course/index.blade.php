...
@section('content')
    <div class="w-full flex flex-col pb-4">
        <div class="bg-white rounded-lg">
                            ...
                            <span class="block w-10 lg:w-full">{{ $i }}</span>
                                        ...
                                        <div
                                            ...
                                            <div class="w-20 lg:w-full">
                                                ...
                                                src={{ asset('storage/' . $course->picture) }}> --}}
                                            </div>
                                        </div>
                                        <div
                                            ...
                                            <a href="{{ route('course.single', [$course->id]) }}"
                                                class="block w-20 lg:w-full">{{ $course->title }}</a>
                                        </div>
                                        <div
                                        class="p-1 lg:p-3 text-xs lg:text-sm h-full flex items-center justify-center text-gray-900 text-center col-span-2">
                                        {{-- <a href="{{ route('user.show', [$course->user->id]) }}"
                                            class="block w-30 lg:w-full">{{ $course->user->name }}
                                            {{ $course->user->family }}</a> --}}
                                        </div>
                                        <div
            ...
            <div
            class="p-1 lg:p-3 text-xs text-center lg:text-sm h-full flex items-center justify-center font-medium">
            <a href="{{ route('course.menus', [$course]) }}"
