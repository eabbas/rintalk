...
<body class="bg-gradient-to-br from-slate-50 to-blue-50 font-sans p-6 lg:p-8">
    ...
    <div class="max-w-5xl mx-auto">
        ...
        <!-- فرم اصلی -->
        <form action="{{route('course.store')}}" method="POST" class="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 md:p-8 space-y-6" enctype="multipart/form-data">
            @csrf
