@extends('welcome')
@section('title', 'همه مدیا ها')
@section('content')
    <div class="w-full flex flex-col pb-4">
        <div class="bg-white rounded-lg">
            <h2 class="text-lg font-bold text-gray-800 p-4 text-center">لیست مدیاها</h2>
            ...
            <div class="flex flex-col gap-5">
                <div class="w-10/12 mx-auto bg-gray-100 shadow-md rounded mb-5">
                   <div
    class="w-full grid grid-cols-8 items-center divide-x divide-[#f1f1f4] sticky -top-5 bg-gray-100 rounded-t">
    ...
    <div class="py-3 text-center text-xs font-medium text-gray-600 col-span-2">
        <span class="block w-24 lg:w-full">عملیات</span>
                    ...
                    <div class="bg-white divide-y divide-[#f1f1f4]">
                       ...
                       @foreach ($lessonMedias as $lessonMedias)
    <div class="w-full grid grid-cols-8 items-center divide-x divide-[#f1f1f4]">
        ...
        <div class="p-1 lg:p-3 text-xs lg:text-sm h-full flex items-center justify-center text-gray-900 text-center col-span-2">
            <span class="block w-20 lg:w-full">{{ $lessonMedias->lesson->title }}</span>
        </div>
        <div class="p-1 lg:p-3 text-xs lg:text-sm h-full flex items-center justify-center text-gray-900 text-center col-span-2">
            <span class="block w-20 lg:w-full">{{ $lessonMedias->duration }}دقیقه</span>
        </div>
        <div class="col-span-3 flex flex-row items-center justify-center gap-1">
    <a href="{{ route('LessonMedia.single', [$lessonMedias]) }}"
    ...
    <a href="{{ route('LessonMedia.edit', [$lessonMedias]) }}"
    ...
    <a href="{{ route('LessonMedia.delete', [$lessonMedias]) }}"
