            ...
            <h2 class="text-lg font-bold text-gray-800 p-4 text-center">لیست دسته‌بندی‌ها</h2>
                 <div class="flex justify-end w-10/12 mx-auto">
                    <a href="{{ route('category.create') }}"
                        class="px-5 py-1 mb-4 rounded-sm bg-[#eb3254] hover:bg-rose-600 text-white text-xs lg:text-base">افزودن دسته بندی جدید +</a>
                </div>
            <form class="flex flex-col gap-5" action="" method="post">
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="px-1 lg:px-6 py-3 text-center text-xs font-medium text-gray-600 bg-gray-100 col-span-2">
                            <span class="block w-30 lg:w-full">توضیحات</span>
                        </div>
                        <div class="px-1 lg:px-6 py-3 text-center text-xs font-medium text-gray-600 bg-gray-100">
                            <span class="block w-20 lg:w-full">والد</span>
                        </div>
                    ...
                    <div class="bg-white divide-y divide-[#f1f1f4]">
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <a href="{{ route('category.single', [$category->id]) }}"
                                                class="block w-20 lg:w-full font-medium text-gray-800 hover:text-sky-600">{{ $category->title }}</a>
                                        </div>
                                        <div
                                            class="p-1 lg:p-3 text-xs lg:text-sm h-full flex items-center justify-center text-gray-900 text-center col-span-2">
                                            <span class="block w-30 lg:w-full line-clamp-2 text-gray-500">
                                        ...
                                        <div
                                            ...
                                            <span class="block w-24 lg:w-full">
                                                @if($category->parent)
                                                    <span class="inline-flex px-2 py-1 bg-sky-100 text-sky-700 rounded-full text-xs">
                                                        {{ $category->parent->title }}
                                                    </span>
                                                @else
                                                    <span class="inline-flex px-2 py-1 bg-gray-100 text-gray-500 rounded-full text-xs">
                                                        دسته اصلی
                                                    </span>
                                                @endif
                                            </span>
                                        ...
                                        <div class="col-span-4">
                                            <div
                                                class="w-[320px] lg:w-full grid grid-cols-1 divide-x divide-[#f1f1f4] items-center">
                                                <ul class="text-sm mt-1 rounded-sm p-1 grid grid-cols-3">
                                                    <li class="flex justify-center">
                                                        <a href="{{ route('category.single', [$category]) }}"
                        ...
                        @else
                            <div class="py-12 text-center">
                                ...
                                <a href="{{ route('category.create') }}" class="inline-block mt-3 px-4 py-2 bg-sky-500 text-white rounded-lg text-sm hover:bg-sky-600 transition">
