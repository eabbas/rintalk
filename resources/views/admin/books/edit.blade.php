...
<head>
    ...
    <title>  ویرایش کتاب | RinTalk</title>
...
<body class="bg-gradient-to-br from-slate-50 to-blue-50 font-sans p-6 lg:p-8">
    ...
    <div class="max-w-5xl mx-auto">
        ...
        <div class="mb-8 text-center">
            <h1 class="text-3xl font-bold text-gray-800">ویرایش اطلاعات کتاب</h1>
            <p class="text-gray-500 mt-2">اطلاعات کتاب را ویرایش وارد کنید</p>
        </div>

        <!-- فرم اصلی -->
        <form action="{{route('books.update')}}" method="POST" enctype='multipart/form-data' class="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 md:p-8 space-y-6" >
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="col-span-1">
                    ...
                    <input type="text" name="title" class="form-input" value="{{$book->title}}" placeholder="عنوان کتاب را بنویسید" required>
                </div>
            ...
            <div>
                ...
                <textarea name="description" rows="4" class="form-textarea w-full" placeholder="توضیحات کامل کتاب را بنویسید...">{{$book->description}}</textarea>
            </div>

            <!-- خلاصه دوره -->
            <div>
                <label class="form-label">خلاصه</label>
                <textarea name="summary" rows="2" class="form-textarea w-full" placeholder="خلاصه کوتاه (حداکثر ۲۰۰ کاراکتر)">{{$book->summary}}</textarea>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="price" class="form-input" value="{{$book->price}}" placeholder="مثال: 450000">
                </div>

                <!-- تخفیف -->
                <div>
                    <label class="form-label">تخفیف <span class="text-red-500">*</span></label>
                    <input type="text" name="discount" class="form-input" value="{{$book->discount}}" placeholder="قیمت با تخفیف">
                </div>
            ...
            <div class="flex flex-wrap gap-6">
                <label class="flex items-center gap-2 cursor-pointer">
                    <input type="checkbox" name="active" value="1" class="w-5 h-5 text-primary-600 rounded border-gray-300 focus:ring-primary-500" {{$book->active ? 'checked' : ''}}>
                    <span class="text-gray-700">فعال</span>
                </label>
                <label class="flex items-center gap-2 cursor-pointer">
                    <input type="checkbox" name="show_in_home" value="1" class="w-5 h-5 text-primary-600 rounded border-gray-300 focus:ring-primary-500" {{$book->show_in_home ? 'checked' : ''}}> 
