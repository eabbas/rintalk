...
@section('content')
    <div class="w-full flex flex-col pb-4">
        <div class="bg-white rounded-lg">
            ...
            <h2 class="text-lg font-bold text-gray-800 p-4 text-center">لیست کتاب ها</h2>
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="px-1 lg:px-6 py-3 text-center text-xs font-medium text-gray-600 bg-gray-100 col-span-2">
                            <span class="block w-20 lg:w-full">عنوان کتاب</span>
                        </div>
                        <div class="px-1 lg:px-6 py-3 text-center text-xs font-medium text-gray-600 bg-gray-100 col-span-2">
                        ...
                        @if ($books)
                            @foreach ($books as $book)
                                ...
                                <div class="w-10 lg:w-full">
                                    <input type="checkbox" class="check" name="courses[]" value="{{ $book->id }}">
                                </div>
                            </div>
                            <div
                            class="p-1 lg:p-3 text-xs lg:text-sm h-full flex items-center justify-center text-gray-900 text-center">
                            <span class="block w-10 lg:w-full">{{ $i }}</span>
                                        ...
                                        <div
                                            ...
                                            <a href="{{ route('books.single', [$book->id]) }}"
                                                class="block w-20 lg:w-full">{{ $book->title }}</a>
                                        </div>
                                        <div
                                ...
                                <div class="col-span-2">
                                    <div
                                    class="w-[300px] lg:w-full grid grid-cols-1 divide-x divide-[#f1f1f4] items-center ">
                                    
                                    <ul class="text-sm mt-1 rounded-sm p-1 grid grid-cols-3">
                                        <li class="flex justify-center">
                                            <a href="{{ route('books.single', [$book]) }}"
